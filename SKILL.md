...
| | | L10 UI応答性 | ARR (Action-Response Rate) |
...
**検出対象**: 動かない / エラー隠蔽 / データ断絶 / 操作後無反応 / 表示矛盾 / セキュリティ脆弱性 / 耐障害性欠如 / 暗黙知の罠
...
- `references/detection-patterns.md` — L1-L6, L10 スタック非依存 grep/glob クエリ集
